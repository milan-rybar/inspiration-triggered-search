...
// Copy constructor
Genome::Genome(const Genome& a_G) : fitness(a_G.fitness), m_NeuronGenes(a_G.m_NeuronGenes), m_LinkGenes(a_G.m_LinkGenes)
{
    m_ID          = a_G.m_ID;
    m_Depth       = a_G.m_Depth;
    ...
    scaledFitness = a_G.scaledFitness;
    descriptionIndex = a_G.descriptionIndex;
}
...
bool Genome::Mutate_AddLink(InnovationDatabase &a_Innovs, Parameters& a_Parameters, RNG& a_RNG)
{
    ...
    // the From neuron has less SplitY value
