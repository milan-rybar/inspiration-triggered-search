...
///////////////////////////////////////////////////////////////////
    ...
    void (Genome::*Genome_SetFitness)(double) = &Genome::SetFitness;
...
///////////////////////////////////////////////////////////////////
    ...
    class_<Genome, Genome*>("Genome", init<>())
            ...
            .def("GetScaledFitness", &Genome::GetScaledFitness)
            .def("GetDescriptionIndex", &Genome::GetDescriptionIndex)
            .def("SetFitness", Genome_SetFitness)
...
///////////////////////////////////////////////////////////////////
    ...
    class_<Population, boost::shared_ptr<Population>>("Population", init<Genome, Parameters, bool, double>())
            .def(init<char*>())
...
/////////////////////////////////////////////////////////
    ...
    class_< std::vector<std::vector<Genome>> >("GenomeListList")
            .def(vector_indexing_suite< std::vector<std::vector<Genome>> >() )
            ;
