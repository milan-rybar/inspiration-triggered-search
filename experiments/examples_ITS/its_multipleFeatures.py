        ...
        for ins in [0.04, 0.05]:
            for remPar in [0.2, 0.3]:
                for rem in [True, False]:
                    ...
                    names.append("its/NV+RS/" + "inspCrit=" + str(ins) + ("_remWin=" + str(remPar) if rem else "_noRemWin") + ("_doublePenalty" if DP else "_noPenalty"))
        ...
        for ins in [0.1]:
            for remPar in [0.4, 0.5]:
                for rem in [True, False]:
                    ...
                    doublePenalty.append(DP)
                    inspirationCriterionThreshold.append(ins)
                    names.append("its/NV+RS+GCF/" + "inspCrit=" + str(ins) + ("_remWin=" + str(remPar) if rem else "_noRemWin") + ("_doublePenalty" if DP else "_noPenalty"))
        ...
        for ins in [0.1]:
            for remPar in [0.4, 0.5]:
                for rem in [True, False]:
                    ...
                    doublePenalty.append(DP)
                    inspirationCriterionThreshold.append(ins)
                    names.append("its/NV+RS+T/" + "inspCrit=" + str(ins) + ("_remWin=" + str(remPar) if rem else "_noRemWin") + ("_doublePenalty" if DP else "_noPenalty"))
        ...
        for ins in [0.1]:
            for remPar in [0.4, 0.5]:
                for rem in [True, False]:
                    ...
                    doublePenalty.append(DP)
                    inspirationCriterionThreshold.append(ins)
                    names.append("its/NV+RS+GCF+T/" + "inspCrit=" + str(ins) + ("_remWin=" + str(remPar) if rem else "_noRemWin") + ("_doublePenalty" if DP else "_noPenalty"))
