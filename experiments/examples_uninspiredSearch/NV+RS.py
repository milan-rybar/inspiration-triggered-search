...
def runExperiment(trial):
    printMessage = "Trial: ", trial
    print "START: ", printMessage

    # create experiment directory
    directory = createNumberedDirectory(os.path.join(workingDirectory, "NV+RS/trial_"))
    ...
    # feature
    a.Features.append(its.NormalizedVariance())
    a.Features.append(its.RelaxedSymmetry())
